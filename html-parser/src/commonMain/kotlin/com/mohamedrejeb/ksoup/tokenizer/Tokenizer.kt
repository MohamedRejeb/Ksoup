...
import com.mohamedrejeb.ksoup.parser.ParserOptions
...
class Tokenizer(
    ...
    private val entityDecoder = EntityDecoder(
        decodeTree = ushortArrayOf(),
//        decodeTree = GeneratedDecodeDataHtml.decodeDataHtml,
    ...
    private fun stateInEntity() {
        val length = this.entityDecoder.write(
            this.buffer,
